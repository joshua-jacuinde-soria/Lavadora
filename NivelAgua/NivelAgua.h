/*
    ...
    Alumn :Sonia Maurilia Gonzalez Villa
...
void nivel_agua() {
        if (!gpio_get(BOTON_P)) {
            ...
            send_cmd(led_state_lev, 0x68);
            // gpio_put(LED_Bajo, (led_state_lev == 0));
            // gpio_put(LED_Medio, (led_state_lev == 1));
            // gpio_put(LED_Alto, (led_state_lev == 2));
    }
}