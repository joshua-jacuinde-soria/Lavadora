...
//     while (cont < 100) {
//         for (int i = 0; i < 8; i++) {
//             int32_t mask_1 = ~bits[i] << FIRST_GPIO_DISPLAY1; // Invertir los bits para ánodo común en el primer display
//             int32_t mask_2 = ~bits[i] << FIRST_GPIO_DISPLAY2; // Invertir los bits para ánodo común en el segundo display
            
//             // Encender ambos displays
//             gpio_set_mask(mask_1 | mask_2);
//             sleep_ms(2);
            
//             // Apagar ambos displays
//             gpio_clr_mask(mask_1 | mask_2);
//         }
//         cont++;
//     }
// }
